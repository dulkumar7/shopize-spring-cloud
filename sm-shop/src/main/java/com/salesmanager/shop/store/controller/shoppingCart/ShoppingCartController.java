...
//			com.salesmanager.core.model.shoppingcart.ShoppingCart customerCart = shoppingCartService.getByCustomer(customer);
			...
			com.salesmanager.core.model.shoppingcart.ShoppingCart customerCart = shoppingCartServiceClient.getByCustomer(customer);
...
//			shoppingCart = shoppingCartFacade.getShoppingCartData(item.getCode(), store, language);
        ...
        throws Exception
    {
      ...
      //ShoppingCartData shoppingCart = shoppingCartServiceClient.getShoppingCartData(customer, store, cartCode, language);
...
//        else
//        {
//            if ( StringUtils.isNotBlank( cartCode ) && cart == null )
//            {
//            	 LOG.info( "getByCartIdAndCodet..." );
//                //cart = shoppingCartService.getByCode( shoppingCartId, store ); // End point
//            	 cart = shoppingCartServiceClient.getByCartIdAndCode(cartCode, store);
//                
//            }
//
//        }
//        shoppingCart = shoppingCartFacade. getShoppingCartData(cart, language);
