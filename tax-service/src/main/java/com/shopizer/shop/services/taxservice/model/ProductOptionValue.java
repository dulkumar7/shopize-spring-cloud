...
@Entity
@Table(name="PRODUCT_OPTION_VALUE", schema = TaxServiceConstants.DB_SCHEMA_NAME, indexes = { @Index(name="PRD_OPTION_VAL_CODE_IDX", columnList = "PRODUCT_OPTION_VAL_CODE")}, uniqueConstraints=
