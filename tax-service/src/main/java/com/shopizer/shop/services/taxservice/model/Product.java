...
@Table(name = "PRODUCT", schema = TaxServiceConstants.DB_SCHEMA_NAME, uniqueConstraints=
...
public class Product extends SalesManagerEntity<Long, Product> implements Auditable {
    ...
    @JoinTable(name = "PRODUCT_CATEGORY", schema = TaxServiceConstants.DB_SCHEMA_NAME, joinColumns = {
